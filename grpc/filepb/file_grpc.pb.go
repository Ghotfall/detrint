...
func (c *fileServiceClient) GetStat(ctx context.Context, in *StatRequest, opts ...grpc.CallOption) (*StatResponse, error) {
...
func (UnimplementedFileServiceServer) GetStat(context.Context, *StatRequest) (*StatResponse, error) {
...
func _FileService_GetStat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StatRequest)
